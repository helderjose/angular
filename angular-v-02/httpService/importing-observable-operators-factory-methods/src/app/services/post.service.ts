...
/*
Só esse linha é desse exemplo.
Comente a linha e click em delete - "an unexpected error occurred"
Descomente a linha e click em delete - "This post has already been deleted"
Analise o console no navegador.
*/
